        ...
        <h2 className="text-2xl font-semibold mb-8 text-amber-600 text-center">Stories of Self Transformation</h2>
          <Carousel maxVisibility={2}>
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/1.png"
              borderSize="2"
            />
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/2 (1).jpeg"
              borderSize="2"
            />
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/3.png"
              borderSize="2"
            />
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/4 (1).jpeg"
              borderSize="2"
            />
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/5.jpg"
              borderSize="2"
            />
            <Card
            ...
            imageSrc="/public/Images/SuccessStories/6.png"
              borderSize="2"
            />
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/7 (1).jpeg"
              borderSize="2"
            />
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/8.jpg"
              borderSize="2"
            />
          </Carousel>
        </section>
  ...
  Voices of Change Makers
          ...
          <Carousel maxVisibility={2}>
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/1.jpg"
              borderSize="2"
            />
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/2.jpg"
              borderSize="2"
            />
            <Card
...
This wasn’t just a financial success. It was a lesson in teamwork, community support, and self-reliance. Most importantly, it deepened the bond between Akshar Kendra and the people of Ganjigatti, showing the true power of trust and collaboration.</p>
              ...
              imageSrc="/public/Images/SuccessStories/3.jpg"
              borderSize="2"
            />
            <Card
              ...
              imageSrc="/public/Images/SuccessStories/4.jpg"
              borderSize="2"
            />
          </Carousel>
        </section>
