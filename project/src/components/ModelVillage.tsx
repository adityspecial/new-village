  ...
  const processSteps = [
    {
      ...
      description: "A Gram Samiti (village committee) is formed with local representatives to ensure community participation in development initiatives. This committee serves as the backbone for decision-making and execution."
    },
    {
      title: "Community Engagement & Need Identification",
      description: "Regular discussions, surveys, and participatory rural appraisal (PRA) methods help identify the real needs of the community. This ensures that initiatives align with local aspirations and challenges."
    },
    {
      title: "Capacity Building & Training",
      description: "Skill development programs, awareness sessions, and leadership training empower villagers with knowledge and tools to drive change effectively."
    },
    {
      title: "Participatory Implementation & Execution",
      description: "Based on identified needs, planned interventions are executed in collaboration with government schemes, NGOs, and local resources. The Gram Samiti plays a key role in mobilization and resource utilization."
    },
    {
      title: "Participatory Monitoring, Feedback & Course Correction",
      description: "Continuous assessment and community feedback help refine strategies, address challenges, and enhance impact. Regular meetings ensure transparency and accountability."
    },
    {
      title: "Self-Sustaining & Empowered Communities",
      description: "Over time, the village develops self-reliant systems, reducing dependency on external support. Empowered communities take ownership of their progress, ensuring long-term sustainability."
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              We envision thriving village communities that maintain their cultural heritage
              while embracing sustainable progress and economic opportunities.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              To empower rural communities through education, sustainable agriculture,
              and preservation of traditional crafts while creating economic opportunities for villagers.
            </p>
          </div>
        </div>
